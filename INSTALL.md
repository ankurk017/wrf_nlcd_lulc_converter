...
**Windows:**
Download and install from [OSGeo4W](https://trac.osgeo.org/osgeo4w/) or use [conda-forge](https://conda-forge.org/).
...
1. **Read the documentation**: See `README.md` for usage examples
...
- **Documentation**: See `README.md` and docstrings in the code
